...
async function index() {
	...
	await fs.writeFileSync('./result.txt', + new Date() + ': studios started' + JSON.stringify(before) + '\n', { flag : 'a'})
	...
	await fs.writeFileSync('./result.txt', + new Date() + ': studios ended' + JSON.stringify(after) + '\n\n', { flag : 'a'})
} 
